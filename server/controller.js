...
module.exports = {
    getAllClients: (req, res) => {
        sequelize.query(`select * from cc_clients c join cc_users u on c.user_id=u.user_id`)
    ...
    getPastAppointments: (req, res) => {
        const qry = `select appt_id, date, service_type, notes, first_name, last_name
        from cc_appointments app
        join cc_clients c on app.client_id=c.client_id
